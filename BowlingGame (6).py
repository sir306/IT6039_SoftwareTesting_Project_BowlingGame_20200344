...
class BowlingGameTests(unittest.TestCase):
    ...
    # Test Case ID 6 - check to see a full game of spares, gutters, strikes and open frames expected score 95
    ...
    # Test Case ID 8 - check to see if even score values are calculated incorrectly expected score total 106
    ...
    # Test Case ID 9 - Test game with all frames totaling to odd numbers and expected score total 39
